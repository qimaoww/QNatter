...
func TestAddPortMappingRequestMatchesIGDSoap(t *testing.T) {
	...
	if got := req.Header.Get("User-Agent"); got != "curl/8.0.0 (QNatter)" {
	...
	for _, want := range []string{
		...
		"<NewPortMappingDescription>QNatter</NewPortMappingDescription>",
...
func TestAddPortMappingSendsSOAPRequest(t *testing.T) {
	...
	if !strings.Contains(gotBody, "<NewPortMappingDescription>QNatter</NewPortMappingDescription>") {
