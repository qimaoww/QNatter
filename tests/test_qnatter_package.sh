...
assert_contains luci-app-qnatter/root/usr/share/luci/menu.d/luci-app-qnatter.json '"path"[[:space:]]*:[[:space:]]*"qnatter/status-v12"'
...
assert_contains luci-app-qnatter/htdocs/luci-static/resources/view/qnatter/status-v12.js 'qnatter-copy-button'
assert_contains luci-app-qnatter/htdocs/luci-static/resources/view/qnatter/status-v12.js 'address-copy4'
