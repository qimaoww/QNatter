...
assert_contains natter/files/natter-notify 'api/v2/app/preferences'
...
[ "$natter_release" -ge 24 ] || fail "natter package release must increase when package files change"
...
assert_contains luci-app-natter/htdocs/luci-static/resources/view/natter/instances.js 'findCloudflareOption'
